...
public class Pidgeotto_N extends Pokemon implements IPokemon_Actions {

    public Pidgeotto_N(AllPokemons Name, int HP, int Attack, int Defense, int SpecialAttack, int SpecialDefense, PokemonType Type, PokemonType Strong, PokemonType Weak) {
