...
public class Magmortar_F extends Pokemon implements IPokemon_Actions {

    public Magmortar_F(AllPokemons Name, int HP, int Attack, int Defense, int SpecialAttack, int SpecialDefense, PokemonType Type, PokemonType Strong, PokemonType Weak) {
