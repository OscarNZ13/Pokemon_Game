...
public class Blaziken_F extends Pokemon {

    public Blaziken_F(AllPokemons Name, int HP, int Attack, int Defense, int SpecialAttack, int SpecialDefense, PokemonType Type, PokemonType Strong, PokemonType Weak) {
